...
const districtTips = {
  limassol: "Famous for its vibrant festivals and agrotourism villages like Omodos.",
  nicosia: "Explore the historic Venetian walls and traditional crafts.",
  paphos: "Discover the birthplace of Aphrodite and stunning coastal trails.",
  kyrenia: "Known for its historic harbor and breathtaking castle views.",
  larnaca: "Visit the Salt Lake and the ancient Church of Saint Lazarus.",
  famagusta: "Explore the medieval old town and the ghost city of Varosha."
};
</script>

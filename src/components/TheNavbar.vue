...
.search-bar.active { width: 320px; border-color: #b57b52; }
...
.search-icon-btn:hover { color: #b57b52; }

.search-input {
  border: none; outline: none; background: transparent;
  font-size: 0.875rem; color: #1c2a32; width: 100%; min-width: 0;
}
...
.clear-btn {
  ...
  padding: 4px; flex-shrink: 0; transition: color 0.2s;
}
...
.search-result:hover { background: #faf9f7; }

.result-thumb {
  width: 44px; height: 44px; border-radius: 8px;
  object-fit: cover; flex-shrink: 0;
}
.result-thumb--placeholder { background: #e5e7eb; }

.result-text { display: flex; flex-direction: column; gap: 2px; min-width: 0; }
.result-title {
  font-size: 0.875rem; font-weight: 500; color: #1c2a32;
  white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
}
.result-meta { font-size: 0.75rem; color: #9ca3af; text-transform: capitalize; }
.search-empty { padding: 16px; font-size: 0.875rem; color: #9ca3af; text-align: center; }
